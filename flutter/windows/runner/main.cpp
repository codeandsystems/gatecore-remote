// KONUM: flutter\windows\runner\main.cpp
                      ...
                      _In_ wchar_t *command_line, _In_ int show_command)
{
  ...
  if (!c_args)
  {
    ...
    // std::cout << "GateCore Remote [" << args_str << "], core returns false, exiting without launching Flutter app." << std::endl;
    return EXIT_SUCCESS;
  }
  ...
  std::wstring app_name = L"GateCore Remote";
